...
internal static class TestsForDev
{
    public static void TwoLineParser()
    {
        ...
        new Pipeline()
            ...
            .AddItem(new Filter<LogEntry>{ Function = (e => e.Level <= LogLevel.Warning) })
            ...
            {
                Function = entry => $"{entry.Time:yyyy-MM-dd HH:mm:ss.fff} {entry.Level, -16} {entry.Category, -12} {entry.Message}"
            })
    ...
    internal static void TwoLineParserIoT()
    {
        ...
        new Pipeline()
            ...
            .AddItem(counter)
            .AddItem(errorAggregator)
            .AddItem(new Filter<LogEntry>{ Function = e => e.Message.StartsWith("[IoT ") })
            .AddItem(new Formatter<LogEntry>
            {
                Function = entry => $"{entry.Time:yyyy-MM-dd HH:mm:ss.fff} {entry.Message}"
            })
            .AddItem(new ConsoleWriter())
            .Run();
        Console.WriteLine("===========================================================");
    ...
    internal static void TwoLineParser_Manfred_Experimental()
    {
        ...
        new Pipeline()
            ...
            .AddItem(new Transformer<LogEntry, LogEntry>
            {
                Function = entry =>
                {
    ...
    internal static void TwoLineParser_Manfred_RentalAndIoT()
    {
        ...
        new Pipeline()
            ...
            .AddItem(new FileWriter { FilePath = @"D:\__temp\logs\analízis\test-20250618_142218-RentalsAndIoT.txt" })
            .AddItem(new Filter<string>{ Function = s =>
            ...
            .AddItem(new Transformer<string, string>
            {
                Function = s =>
                {
    ...
    internal static void CompactJsonParser_Manfred_RentalAndIoT()
    {
        ...
        new Pipeline()
            ...
            .AddItem(new FileWriter { FilePath = @"D:\__temp\logs\analízis\log-local-compactjson-20250620_163228-RentalsAndIoT.txt" })
            .AddItem(new Filter<string> {
                Function = s =>
                    s.Contains(" initiated for user ") ||
                    s.Contains(" started for user") ||
                    s.Contains("WaitForPayment --> Finished") ||
    ...
    internal static void CompactJsonParser_Manfred_Prod_FilesAndDates()
    {
        new Pipeline()
            ...
            .AddItem(new Transformer<string, string>
            {
                Function = line => $"    {(line.Length > 60 ? line.Substring(0, 60) : line)}"
            })
            .AddItem(new ConsoleWriter())
            .Run();
    }
...
//            .AddItem(new LogSource(@"D:\__temp\logs\manfredrepo-prod-all", @"log-20251103_034508.txt"))
    ...
    internal static void CompactJsonParser_Manfred_SecurityQueueError()
    {
        ...
        new Pipeline()
            ...
            .AddItem(new FileWriter { FilePath = $"{fileName}\\data\\filtered.log" })
            .Run();
        ...
        new Pipeline()
            ...
            .AddItem(new FileWriter { FilePath = $"{fileName}\\data\\threads.log" })
            .Run();
        ...
        new Pipeline()
            ...
            .AddItem(new FileWriter { FilePath = $"{fileName}\\data\\registration-requests.log" })
            .Run();
        ...
        new Pipeline()
            ...
            .AddItem(new FileWriter { FilePath = $"{fileName}\\data\\threads_table.log" })
            .Run();
